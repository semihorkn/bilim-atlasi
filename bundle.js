...
`)+`
`+d);let w=E+g+a,v=E+d+o,A=cu(r,r.VERTEX_SHADER,w),S=cu(r,r.FRAGMENT_SHADER,v);r.attachShader(b,A),r.attachShader(b,S),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function k(R){if(i.debug.checkShaderErrors){let U=r.getProgramInfoLog(b)||"",q=r.getShaderInfoLog(A)||"",J=r.getShaderInfoLog(S)||"",B=U.trim(),X=q.trim(),G=J.trim(),$=!0,Q=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,b,A,S);else{let ue=hu(r,A,"vertex"),me=hu(r,S,"fragment");Re("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
